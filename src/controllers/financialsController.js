...
module.exports = {
    ...
    listAcquittances: async (req, res) => {
        try {
            ...
            const result = await contaAzul.get('/v1/baixas', { params: apiParams })
    ...
    listCharges: async (req, res) => {
        try {
            ...
            const result = await contaAzul.get('/v1/receivables', { params: apiParams })
    ...
    listCostCenters: async (req, res) => {
        try {
            ...
            const result = await contaAzul.get('/v1/centro-de-custo', { params: apiParams })
