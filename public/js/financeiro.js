...
// Handler para Cobranças (Contas a Receber)
window.appHandlers.cobrancas = {
    format: function (rawData) {
...
// Handler para Centro de Custos
window.appHandlers.centro_de_custos = {
    format: function (rawData) {
